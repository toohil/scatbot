...
const steps = [
"Check that your sample pack contains: a plastic lunch-box size container with a lid (sample container), disposable gloves, 2 zip lock bags, an AnaeroGen sachet, a paper envelope, and a freezer block.",
"The night before, place the freezer block in the freezer overnight to freeze.",
"To begin the procedure, place the frozen freezer block in one of the ziplock bags.",
"Put on the disposable gloves.",
"Place the plastic container onto the toilet bowl and perform bowel movement into it (the whole bowel motion, not just part of it). Please avoid getting any urine in the plastic container and do not wrap or cover the sample in toilet paper.",
...
"Write down the sample in the fridge until you leave for the research lab session"
]
